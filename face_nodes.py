...
import pandas as pd # Import pandas for nice text formatting
    ...
    for i, img_path in enumerate(image_paths):
        ...
        try:
            ...
            for rep_idx, rep_obj in enumerate(img_representations):
                embedding_data = {
                    'target_image': os.path.basename(img_path), # Store just the basename for cleaner output
...
# --- Node 2: Find Matching Faces (HEAVILY MODIFIED) ---
class FaceDB_FindMatches:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            "required": {
                ...
                "top_n": ("INT", {"default": 10, "min": 1, "max": 1000}), # NEW INPUT
            }
        }
    ...
    def find_matches(self, face_database, source_image, detector_backend, similarity_threshold, top_n):
        ...
        # --- Generate Image Outputs (based on the single best match) ---
